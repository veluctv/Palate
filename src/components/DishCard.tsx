...
export const DishCard: React.FC<DishCardProps> = ({ dish, onClick }) => {
  ...
  return (
    ...
    >
      <div className="dish-poster relative overflow-hidden rounded-2xl aspect-square">
        <img 
        ...
        />
        <div className="absolute top-3 right-3 bg-accent text-black px-2 py-1 rounded-lg flex items-center gap-1 shadow-lg">
